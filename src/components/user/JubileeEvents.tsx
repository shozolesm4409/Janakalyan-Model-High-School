    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 font-sans">
        {events.length === 0 ? (
          ...
          events.map((event) => (
            <div key={event.eventId} className="border border-gray-100 rounded-xl p-4 hover:border-primary/20 transition-all duration-300 flex items-start space-x-4 bg-gray-50 hover:bg-white hover:shadow-sm text-left">
